...
export class _WebAudioBusAndSoundSubGraph extends _WebAudioBaseSubGraph {
    ...
    async init(options) {
        ...
        if ((hasSpatialOptions = _HasSpatialAudioOptions(options))) {
            this.createAndAddSubNode("Spatial" /* AudioSubNode.SPATIAL */);
        }
        if ((hasStereoOptions = _HasStereoAudioOptions(options))) {
            this.createAndAddSubNode("Stereo" /* AudioSubNode.STEREO */);
        }
    ...
    _onSubNodesChanged() {
        ...
        if (spatialNode && stereoNode) {
            ...
            this._rootNode.connect(spatialNode.outNode);
            this._rootNode.connect(stereoNode.outNode);
        }
        else {
